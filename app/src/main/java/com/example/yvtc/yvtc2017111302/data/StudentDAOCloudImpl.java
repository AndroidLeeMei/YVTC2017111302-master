...
import com.example.yvtc.yvtc2017111302.MainActivity;
import com.example.yvtc.yvtc2017111302.MyAdapter;
...
public class StudentDAOCloudImpl implements StudentDAO {
    ...
    String TAG="StudentDAOCloudImpl";
    int MaxID;
    ...
    public StudentDAOCloudImpl(final Context context) {
        ...
        myRef = database.getReference("LeeMeistudentdata");
...
//        myRef.setValue("Hello, World!");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                MaxID += 1;
                Log.d("StudentDAOCloudImpl2", "Value is: " + value);
